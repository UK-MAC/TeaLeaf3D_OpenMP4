...
CONTAINS
  ...
  SUBROUTINE update_halo_kernel(x_min, x_max, y_min, y_max, z_min, z_max, chunk_neighbours, &
  ...
  REAL(KIND=8), DIMENSION(x_min-2:x_max+2,y_min-2:y_max+2,z_min-2:z_max+2) :: density,energy0,energy1,u,p,sd
...
!$OMP TARGET IF(offload.NE.0) MAP(TO:depth) DEVICE(dev_id)
!$OMP PARALLEL
